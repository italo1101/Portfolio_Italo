    ...
    return(
        <div className="home_data">
            <h1 className="home_title">
                ...
                <p className="home_description">Desenvolvedor fullstack com aprendizado em metodologia ágil, tenho habilidades para organizar e gerenciar projetos de forma eficiente. Trabalho desde a fase inicial de design até a implementação completa do projeto, buscando sempre a melhor solução para cada desafio. Sou um estudante de Análise e Desenvolvimento de Sistemas com experiência em desenvolvimento web.</p>
